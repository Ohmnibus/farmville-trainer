namespace Ohm.FarmVille {
	partial class AboutBox {
		...
		private void InitializeComponent() {
			...
			this.labelProjectURL = new System.Windows.Forms.LinkLabel();
			...
			this.tableLayoutPanel.Controls.Add(this.labelProjectURL, 1, 4);
			...
			this.labelProjectURL.Location = new System.Drawing.Point(143, 104);
			...
			this.labelProjectURL.TabIndex = 23;
			this.labelProjectURL.TabStop = true;
			this.labelProjectURL.Text = "Project URL";
			this.labelProjectURL.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.labelProjectURL.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.labelProjectURL_LinkClicked);
			// 
			// textBoxDescription
			// 
			...
			this.Text = "About Farmville Trainer";
		...
		private System.Windows.Forms.LinkLabel labelProjectURL;
